...
// </editor-fold> 
    ...
    public void GenerateStatement_SetProduct(int IdProduct, byte[] ImageProduct, String NameProduct, String DescriptionProduct, double PriceProduct) {
        ...
        try {
            newPreStatement = GeneratePreparedStament("INSERT INTO Product (IdProduct, ImageProduct, NameProduct, DescriptionProduct, PriceProduct) VALUES ( ? , ? , ? , ? , ?);");
    ...
    public void GenerateStatement_UpdateProduct(int IdProduct, byte[] ImageProduct, String NameProduct, String DescriptionProduct, double PriceProduct) {
        ...
        try {
            newPreStatement = GeneratePreparedStament("UPDATE Product SET ImageProduct = ?, NameProduct= ?, DescriptionProduct = ?, PriceProduct = ? where IdProduct = ?;");
            newPreStatement.setBytes(1, ImageProduct);
            newPreStatement.setString(2, NameProduct);
            newPreStatement.setString(3, DescriptionProduct);
            newPreStatement.setDouble(4, PriceProduct);
            newPreStatement.setInt(5, IdProduct);
            newPreStatement.executeUpdate();
        } catch (Exception e) {
