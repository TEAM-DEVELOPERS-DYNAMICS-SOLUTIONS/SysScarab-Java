 ...
 * @author RODX
 */
public class UpdateClient_form extends javax.swing.JFrame {
    ...
    public UpdateClient_form() {
        if (AuthVerify) {
            initComponents();
            this.setLocationRelativeTo(null);

            //PlaceHolders
            TextPrompt PlaceholderId = new TextPrompt("Id/Identidicacion", jTextField_IdClient);
    ...
    private void initComponents() {
        ...
        jLabel_TFSAGenderClient = new javax.swing.JLabel();
        ...
        jTextField_IdClient.setBackground(new java.awt.Color(255, 255, 255));
        jTextField_IdClient.setBorder(null);
        ...
        jLabel_TFSAGenderClient.setFont(new java.awt.Font("Roboto Light", 0, 12)); // NOI18N
        jLabel_TFSAGenderClient.setForeground(new java.awt.Color(36, 36, 36));
        jLabel_TFSAGenderClient.setText("Genero");
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_TextFieldsFormLayout.createSequentialGroup()
                            .addGroup(jPanel_TextFieldsFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(jPanel_TextFieldsFormLayout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel_TextFieldsFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jTextField_IdClient, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGap(1, 1, 1)))
                    .addGroup(jPanel_TextFieldsFormLayout.createSequentialGroup()
                        .addComponent(jLabel_TFSAGenderClient, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel_TextFieldsFormLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_TextFieldsFormLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel_TextFieldsFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel_TFSAGenderClient)
    ...
    private void jLabel_ButtonSaveDataEmployeesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_ButtonSaveDataEmployeesMouseClicked
        String Id = jTextField_IdClient.getText(), Name = jTextField_nameClient.getText(), LastName = jTextField_LastNameClient.getText(), Email = jTextField_EmailClient.getText(), Password = jTextField_PassClient.getText(), Phone = jTextField_PhoneClient.getText(), Address = jTextField_AddressClient.getText();
	...
	try {
        ...
        newStatement.GenerateStatement_UpdateClient(image, Name, LastName, Email, Password, Address, Phone, Gender, Integer.parseInt(Id));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateClient_form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateClient_form().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabel_TFSAGenderClient;
