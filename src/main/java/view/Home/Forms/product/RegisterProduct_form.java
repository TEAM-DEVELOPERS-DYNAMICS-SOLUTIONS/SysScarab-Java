 ...
 * @author RODX
 */
public class RegisterProduct_form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_TitlePanelRE.setText("Registro Productos");
    ...
    private void jLabel_ButtonSaveDataProductMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_ButtonSaveDataProductMouseClicked
        ...
        newStatement.GenerateStatement_SetProduct(Integer.parseInt(Id), convertImage(), Name, Descripcion,  PriceProduct);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterProduct_form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterProduct_form().setVisible(true);
            }
        });
    }
